...
namespace calendar
{
    class Program //写日历，输入年或者年月得到月历
    {
        ...
        static void Main1(string[] args)
        {
            ...
            if (strTime.Contains("天") == true && strTime.Contains("小时") == true && strTime.Contains("分钟") == true)
            {
                //得到天
                int day = GetDay(strTime);
                //得到小时
            ...
            //年历
            else if (strTime.Contains("年") == true && strTime.Contains("月") == false)
            {
                //得到年
                int year = GetYear(strTime);
        ...
        private static int GetHour(string strTime)
        {
            ...
            int strDay = strTime.IndexOf("天");
            int strHour = strTime.IndexOf("时");
            string hourNumber = strTime.Remove(strHour - 2);
